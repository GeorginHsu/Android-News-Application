...
public class NewsDatabaseHelper2 extends SQLiteOpenHelper {


    public NewsDatabaseHelper2(@Nullable Context context) {
        super(context, "news_like", null, 1);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTableQuery =
                "CREATE TABLE " + Constants.LIKE_TABLE_NAME + "(" +
